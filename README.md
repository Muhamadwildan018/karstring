...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Muhamadwildan18/karstring)
...
1. Clone the repo
   ```markdown
   git clone https://github.com/Muhamadwildan18/karstring
   ```
